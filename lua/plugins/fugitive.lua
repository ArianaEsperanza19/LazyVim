-- INFO: Git Fugitive: una herramienta de Git integrada en Neovim que proporciona una interfaz de usuario para gestionar repositorios Git.
...
return {
  {
    "tpope/vim-fugitive", -- Plugin principal de Fugitive
  },
}
