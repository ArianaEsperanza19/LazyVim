    ...
    spec = {
      {
        ...
        { "<leader>t\\", group = "window terminal", icon = "" },
        { "<leader>tv", group = "vertical terminal", icon = "" },
        { "<leader>th", group = "horizontal terminal", icon = "" },
        { "<leader>p", group = "preview", icon = "" },
        { "<leader>pm", group = "markdown preview", icon = "" },
        { "<leader>pt", group = "typst preview", icon = "" },
        ...
        { "<leader>n", desc = "notifications history", icon = "󰍢" },
        { "<leader>di", desc = "dict", icon = "" },
        { "<leader>|", desc = "vertical window", icon = "" },
        { "<leader>wr", desc = "resize window", icon = "󰑝" },
